...
export function ProceduralPouchModel({
  ...
  const laminateMaterial = useMemo(
    () => new THREE.MeshPhysicalMaterial({
      ...
      metalness: solution.material.metalness,
      transmission: solution.material.transmission,
      opacity: solution.material.opacity,
      transparent: solution.material.opacity < 0.999 || solution.material.transmission > 0,
      depthWrite: solution.material.opacity >= 0.98,
      thickness: Math.max(solution.material.caliperMm * MM, 0.001),
      clearcoat: solution.material.clearcoat,
      clearcoatRoughness: solution.material.clearcoatRoughness,
      envMapIntensity: 0.42,
      side: THREE.DoubleSide,
    }),
    [
      solution.material.caliperMm,
      solution.material.clearcoat,
      solution.material.clearcoatRoughness,
      solution.material.color,
      solution.material.metalness,
      solution.material.opacity,
      solution.material.roughness,
      solution.material.transmission,
    ],
  );
