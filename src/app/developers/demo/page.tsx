...
export default function IntegrationDemoPage() {
  return <main className="editorial-page mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 sm:py-12">
    <Link href="/developers" className="editorial-back inline-flex items-center gap-2 text-sm text-[var(--st-dim)]"><ArrowLeft className="h-4 w-4" /> Integration guide</Link>
    <div data-rise className="mb-7 mt-7 max-w-3xl">
    ...
    <div className="rise rise-3"><IntegrationDemo enabled={process.env.NODE_ENV === "development"} /></div>
  </main>;
}
